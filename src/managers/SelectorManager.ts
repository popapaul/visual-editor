import type { SelectorManagerConfig } from 'grapesjs';
const selectorManager: SelectorManagerConfig = {
	// Style prefix
	stylePrefix: 'clm-',

	// Specify the element to use as a container, string (query) or HTMLElement
	// With the empty value, nothing will be rendered
	appendTo: 'grapes-selectors',

	// Default selectors
	selectors: [],

	// States
	states: [{ name: 'hover' }, { name: 'focus' }, { name: 'active' }, { name: 'nth-of-type(2n)' }],
